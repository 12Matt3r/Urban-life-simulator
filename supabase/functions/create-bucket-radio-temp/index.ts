...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["audio/mpeg", "audio/wav", "audio/ogg", "audio/mp3"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for radio" ON storage.objects FOR SELECT USING (bucket_id = 'radio');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for radio" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'radio');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for radio" ON storage.objects FOR UPDATE USING (bucket_id = 'radio');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for radio" ON storage.objects FOR DELETE USING (bucket_id = 'radio');`
    ];
